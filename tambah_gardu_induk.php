...
<div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Tambah Gardu_induk</h4>
		  
        </div>
        <div class="modal-body">
		<form role="form" action="proses/proses_tambah_gardu_induk.php" method="POST">
                                       <div class="form-group">
										...
										<div class="form-group">
                                            <label>Garduk Induk</label>
                                            <input name="gardu_induk" class="form-control" required type="number">
                                            </div>
