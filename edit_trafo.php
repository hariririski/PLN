        ...
        <div id="page-wrapper">
			...
			<table width="90%" align="center">
				<tr>
						...
						<td>
										<div class="form-group">
                                            <input name="id_trafo" class="form-control" required>
                                        </div>
						</td>
					</tr>
				...
				<tr>
						...
						<td>
										<div class="form-group">
                                            <select name="tipe_gardu"  class="form-control" required>
                                                <option value="">Pilih Tipe Gardu</option>
                                               <?php
												  include'share/koneksi.php';
												  $i=0; 
					...
					<tr>
						...
						<td>
										<div class="form-group">
                                            <input name="kubikel" class="form-control" required type="number">
                                        </div>
						</td>				
					</tr>
					...
					<tr>
						...
						<td>
									...
									<center>	<button align="center" type="sumbit" class="btn btn-primary">Tambah</button></center>
		</form>
                </div>
            </div>
           </div>
