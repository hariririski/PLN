...
<div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Edit Penyulang</h4>
		  
        </div>
        <div class="modal-body">
		<form role="form" action="proses/proses_tambah_penyulang.php" method="POST">
										...
										<div class="form-group">
                                            ...
                                            <select name="gardu_hubung" id="gardu_hubung" class="form-control">
												<option value="">-Pilih-</option>
											</select>
                                        </div>
										<div class="form-group">
                                            <label>Nama Penyulang</label>
                                            <input class="form-control" required name="nama_penyulang" >
                                        </div>
										<div class="form-group">
                                            <label>Nama Wilayah Penyulang</label>
                                            <input class="form-control" required name="nama_wilayah_penyulang" >
                                        </div>
										<div class="form-group">
                                            <label>Pembagian Penyulang</label>
                                            <input class="form-control" required name="pembagian_penyulang" >
                                        </div>
